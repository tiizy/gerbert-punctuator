...
def test_trainBertClassification():
    train_path = os.path.join(os.getcwd(), "tests", "training_test_data", "training_data.pt")
    val_path = os.path.join(os.getcwd(), "tests", "training_test_data", "validation_data.pt")
